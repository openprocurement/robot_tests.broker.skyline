...
def convert_skyline_string(string):
    return {
            ...
            u'цей договір запропоновано, але він ще не діє. Можливо очікується його підписання.': 'pending',
            u'цей договір підписаний всіма учасниками, і зараз діє на законних підставах.':       'active',
            u'цей договір було скасовано до підписання.':                                         'cancelled',
